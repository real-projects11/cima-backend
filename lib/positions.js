 ...
 */
export async function reservePosition(slot, { platform, handle, title, desc, btnText, contact }) {
  ...
  const bid = pos && pos.name ? minToDisplace({ rank: slot, price: Number(pos.price) }) : STARTS[slot];
